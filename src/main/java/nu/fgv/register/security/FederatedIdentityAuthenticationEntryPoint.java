...
public final class FederatedIdentityAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public FederatedIdentityAuthenticationEntryPoint(final String loginPageUrl, final ClientRegistrationRepository clientRegistrationRepository) {
    ...
    public void commence(
        ...
        final String idp = request.getParameter("idp");

        if (idp != null) {
            final ClientRegistration clientRegistration = this.clientRegistrationRepository.findByRegistrationId(idp);
    ...
    public void setAuthorizationRequestUri(final String authorizationRequestUri) {
