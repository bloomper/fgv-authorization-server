package nu.fgv.register.security;
...
public final class FederatedIdentityConfigurer extends AbstractHttpConfigurer<FederatedIdentityConfigurer, HttpSecurity> {
     ...
     */
    public FederatedIdentityConfigurer loginPageUrl(final String loginPageUrl) {
     ...
     * @return This configurer for additional configuration
     */
    public FederatedIdentityConfigurer authorizationRequestUri(final String authorizationRequestUri) {
     ...
     * @return This configurer for additional configuration
     */
    public FederatedIdentityConfigurer oauth2UserHandler(final Consumer<OAuth2User> oauth2UserHandler) {
     ...
     * @return This configurer for additional configuration
     */
    public FederatedIdentityConfigurer oidcUserHandler(final Consumer<OidcUser> oidcUserHandler) {
    ...
    public void init(final HttpSecurity http) throws Exception {
        ...
        final FederatedIdentityAuthenticationEntryPoint authenticationEntryPoint = new FederatedIdentityAuthenticationEntryPoint(this.loginPageUrl, clientRegistrationRepository);

        if (this.authorizationRequestUri != null) {
            authenticationEntryPoint.setAuthorizationRequestUri(this.authorizationRequestUri);
        }

        final FederatedIdentityAuthenticationSuccessHandler authenticationSuccessHandler = new FederatedIdentityAuthenticationSuccessHandler();
        ...
        http
                ...
                .oauth2Login(oauth2Login -> {
                    ...
                    if (this.authorizationRequestUri != null) {
                        final String baseUri = this.authorizationRequestUri.replace("/{registrationId}", "");
